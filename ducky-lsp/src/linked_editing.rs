...
pub fn get_linked_editing_ranges(content: &str, position: Position) -> Option<LinkedEditingRanges> {
    ...
    if let Some(line) = lines.get(position.line as usize) {
        ...
        match token_type {
            ...
            TokenType::EndIf => find_block_pair_reverse(
                &lines,
                position.line,
                TokenType::If,
                TokenType::EndIf,
            ...
            TokenType::While => find_block_pair(
                &lines,
                position.line,
                TokenType::While,
                TokenType::EndWhile,
            ...
            TokenType::EndWhile => find_block_pair_reverse(
                &lines,
                position.line,
                TokenType::While,
                TokenType::EndWhile,
            ...
            TokenType::Function => find_function_pair(&lines, position.line),
            TokenType::EndFunction => find_function_pair_reverse(&lines, position.line),
            TokenType::Extension => find_block_pair(
                &lines,
                position.line,
                TokenType::Extension,
            ...
            TokenType::EndExtension => find_block_pair_reverse(
                &lines,
                position.line,
                TokenType::Extension,
                TokenType::EndExtension,
            ...
            TokenType::Stage => find_block_pair(
                &lines,
                position.line,
                TokenType::Stage,
                TokenType::EndStage,
            ...
            TokenType::EndStage => find_block_pair_reverse(
                &lines,
                position.line,
                TokenType::Stage,
                TokenType::EndStage,
            ...
            TokenType::ButtonDef => find_block_pair(
                &lines,
                position.line,
                TokenType::ButtonDef,
            ...
            TokenType::EndButtonDef => find_block_pair_reverse(
                &lines,
                position.line,
                TokenType::ButtonDef,
                TokenType::EndButtonDef,
            ...
            TokenType::StringBlock | TokenType::StringLnBlock => find_block_pair(
                &lines,
                position.line,
                token_type,
                TokenType::EndString,
            ...
            TokenType::EndString => find_string_block_reverse(&lines, position.line),
            TokenType::RemBlock => find_block_pair(
                &lines,
                position.line,
                TokenType::RemBlock,
            ...
            TokenType::EndRemBlock => find_block_pair_reverse(
                &lines,
                position.line,
                TokenType::RemBlock,
                TokenType::EndRemBlock,
    ...
    for (idx, line) in lines.iter().enumerate().skip(start_line as usize + 1) {
        ...
        if token_type == start_token {
            ...
            if depth == 0 {
                // Found matching end
                let start_range =
                    get_keyword_range(lines[start_line as usize], start_line, keyword);
    ...
    for idx in (0..end_line as usize).rev() {
        ...
        if token_type == end_token {
            ...
            if depth == 0 {
                ...
                let end_range = get_keyword_range(
